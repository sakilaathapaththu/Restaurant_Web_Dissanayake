...
//                             <Typography variant="h4" sx={{ color: '#f57c00', mb: 1 }}>
//                                 {stats.weekOrders}
//                             </Typography>
//                             <Typography variant="body2" color="text.secondary">
//                                 This Week
...
//                             <Typography variant="h4" sx={{ color: '#c2185b', mb: 1 }}>
...
//                             <Typography variant="body1" sx={{ fontWeight: 'medium', color: '#555', mr: 1 }}>
//                                 Show orders:
//                             </Typography>
...
//                                         mr: 1,
//                                         mb: 1,
//                                         color: statusFilter === 'pending' ? 'white' : '#f57c00',
//                                         borderColor: '#f57c00',
...
//                                         mr: 1,
//                                         mb: 1,
//                                         color: statusFilter === 'confirmed' ? 'white' : '#2e7d32',
//                                         borderColor: '#2e7d32',
...
//                                         mr: 1,
//                                         mb: 1,
//                                         color: statusFilter === 'cancelled' ? 'white' : '#d32f2f',
//                                         borderColor: '#d32f2f',
...
//                                 label={`${statusFilter.charAt(0).toUpperCase() + statusFilter.slice(1)} Orders`}
...
//             ) : (
//                 <>
//                     {/* Orders Grid - Same as MyOrdersPage */}
//                     <Box sx={{
//                         display: 'flex',
//                         justifyContent: 'center',
//                         width: '100%'
...
//                                             {/* Order Items Preview - Same as MyOrdersPage */}
//                                             <Box sx={{ mb: 2 }}>
